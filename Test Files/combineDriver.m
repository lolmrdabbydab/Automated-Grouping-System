...
fprintf(['Expected Output: A 3x3 matrix:\n\t' ...
    ...
    '- "Ian" & "Hans" are in the same group\n\t' ...
...
% -= Test Case 2 =- (>1 Combine Team)
groupTable = string(zeros(3, 3));
combineMatrix = ["Ian" "Hans"; "Cindy" "John"];
fprintf(['Parameter: (string(zeros(3, 3)), ' ...
    '["John" "Cindy" "Mike" "Ken" "Luke" "Rick" "Hans" "Tom" "Ian"], \n' ...
    '["Ian" "Hans"; "Cindy" "John"])\n']);
fprintf(['Expected Output: A 3x3 matrix:\n\t' ...
    '- Everyone in the nameList is in the matrix\n\t' ...
    '- "Ian" & "Hans" are in the same group\n\t' ...
    '- "Cindy" & "John" are in the same group\n\t' ...
    '- Each person must only appear once in the matrix\n\t' ...
    '- The fist team is added into the first column starting from the 1st row\n\t' ...
...
nameList = ["John" "Cindy" "Mike" "Ken" "Luke" "Rick" "Hans" "Tom" "Ian" "Tom" "Vicky" "Josh"];
combineMatrix = ["Ian" "Hans"; "Ken" "Luke"; "Cindy" "John"];
fprintf(['Parameter: (string(zeros(3, 3)), ' ...
    '["John" "Cindy" "Mike" "Ken" "Luke" "Rick" "Hans" "Tom" "Ian" "Tom" "Vicky" "Josh"], \n' ...
